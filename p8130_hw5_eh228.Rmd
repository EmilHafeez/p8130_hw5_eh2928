...
The 95% confidence interval for the true slope \(\beta_1 \) is given by \(\widehat{\beta_1} \pm t_{n-2, 1-(\alpha/2)} \cdot se(\widehat{\beta_1}) \) 

where \(se(\widehat{\beta_1}) = \sqrt{MSE / \Sigma_{i=1}^n}(X_i - \overline{X})^2 \)
