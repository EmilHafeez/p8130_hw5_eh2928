...
The 95% confidence interval for the mean freshman GPA for students whose ACT score is 28 is calculated as below. 
...
predict(reg_admit, data.frame(ACT_to_predict_from))
